...
BG = ("The background is one flat cream colour of a single even tone that fills the whole "
      ...
      "line or platform of any kind underneath it. There is no sky, no horizon, no clouds "
      "and no scenery of any kind behind it: the cream colour is the only thing behind "
      "the object, exactly as if the object had been cut out and laid on blank paper.")
