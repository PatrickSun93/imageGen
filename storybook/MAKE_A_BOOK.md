...
**`style` 里的光照描述会盖过 `scene` 的氛围。** 恐龙那本 `style` 写了
`soft natural light`，结果「天空变黑了」那页出来是亮的浅绿天。
情绪转折页（变黑、下雨、夜里）必须**整段替换 style 的光照词**，
光靠在 scene 里写 dark 压不住——两个词打架时 style 赢。
...
| 恐龙没有走远（鸟是恐龙的后代 / 演化） | 复古水粉 | （私有链接，未公开） |
